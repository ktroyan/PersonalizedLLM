...
def get_restaurants_urls(cities_to_scrape):
    ...
    csv_restaurants_file = open(f"./Data/TA_restaurants_urls.csv", "w", encoding="utf-8")
    ...
    # close csv file as nothing more to write
    csv_writer_restaurant.close()
...
if __name__ == "__main__":
    ...
    print(f"{nb_restaurants_urls} restaurants urls found for {nb_of_cities_to_scrape} cities")
